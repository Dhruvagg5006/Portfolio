        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Building robust full-stack web applications and high-performance REST APIs with React, FastAPI, and MySQL, incorporating secure JWT authentication and scalable system architecture.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Engineering machine learning models, computer vision pipelines with OpenCV and MediaPipe, and interactive business intelligence dashboards in Power BI and Tableau.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
